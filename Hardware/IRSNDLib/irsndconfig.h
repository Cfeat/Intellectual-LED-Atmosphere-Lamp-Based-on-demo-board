...
#  define IRSND_PORT_LETTER                     GPIOA					//Port of Transmit PWM Pin e.g.
#  define IRSND_BIT_NUMBER                      GPIO_PIN_11			    //Pim of Transmit PWM Pin e.g.
#  define IRSND_TIMER_HANDLER                   htim1                   //Handler of Timer e.g. htim (see tim.h)
#  define IRSND_TIMER_CHANNEL_NUMBER            TIM_CHANNEL_4           //Channel of the used Timer PWM Pin e.g. TIM_CHANNEL_2
#  define IRSND_TIMER_SPEED_APBX                32000000                //Speed of the corresponding APBx. (see STM32CubeMX: Clock Configuration)
